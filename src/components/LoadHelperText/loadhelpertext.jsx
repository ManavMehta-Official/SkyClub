    ...
    return (
        <section className="loader-container">
            <div className='loader-wrapper'>
                ...
                <ol>
                    <li>
                        <h1><span className='search-guide-field'>Departure</span></h1>
                        <ul>
                    ...
                    <li>
                        <h1><span className='search-guide-field'>Arrival</span></h1>
                        <ul>
                        ...
                        <li>
                            <h1><span className='search-guide-field'>Search From Date</span></h1>
                            <ul>
                        ...
                        <li>
                            <h1><span className='search-guide-field'>Search To Date</span></h1>
                            <ul>
